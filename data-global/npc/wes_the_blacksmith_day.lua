...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "yselda") and player:getStorageValue(Storage.Quest.U12_40.TheOrderOfTheLion.WesTask) < 1 and player:getItemCount(34161) >= 20 then
		npcHandler:say({
	...
	elseif message:lower() == "yes" and player:getStorageValue(Storage.Quest.U12_40.TheOrderOfTheLion.WesTask) < 1 then
		if npcHandler:getTopic(playerId) == 2 and player:removeItem(34161, 20) then
