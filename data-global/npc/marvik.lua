...
keywordHandler:addKeyword({ "spell" }, StdModule.say, {
	...
	text = "I can teach you these spells: {Apprentice's Strike}, {Avalanche Rune}, {Chameleon Rune}, {Chill Out}, {Convince Creature}, {Creature Illusion}, {Cure Poison}, {Cure Poison Rune}, {Destroy Field}, {Energy Field Rune}, {Energy Wall Rune}, {Explosion Rune}, {Find Fiend}, {Find Person}, {Fire Bomb Rune}, {Fire Field Rune}, {Fire Wall Rune}, {Food}, {Great Light}, {Heavy Magic Missile Rune}, {Ice Wave}, {Intense Healing}, {Intense Healing Rune}, {Invisibility}, {Light}, {Light Healing}, {Light Magic Missile Rune}, {Magic Patch}, {Magic Shield}, {Mud Attack}, {Poison Field Rune}, {Poison Wall Rune}, {Stalagmite Rune}, {Summon Creature}, {Terra Wave}, {Ultimate Healing} and {Ultimate Healing Rune}.",
})
...
local node2 = keywordHandler:addKeyword({ "avalanche rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {avalanche rune} magic spell for 1200 gold?" })
...
local node3 = keywordHandler:addKeyword({ "chameleon rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {chameleon rune} magic spell for 1300 gold?" })
...
local node9 = keywordHandler:addKeyword({ "destroy field rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {destroy field rune} magic spell for 700 gold?" })
node9:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "destroy field rune", vocation = { 1, 2, 3, 5, 6, 7, 9, 10 }, price = 700, level = 17 })

local node10 = keywordHandler:addKeyword({ "energy field rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {energy field rune} magic spell for 700 gold?" })
...
local node11 = keywordHandler:addKeyword({ "energy wall rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {energy wall rune} magic spell for 2500 gold?" })
node11:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "energy wall rune", vocation = { 1, 2, 5, 6 }, price = 2500, level = 41 })

local node12 = keywordHandler:addKeyword({ "explosion rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {explosion rune} magic spell for 1800 gold?" })
node12:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "explosion rune", vocation = { 1, 2, 5, 6 }, price = 1800, level = 31 })
...
local node15 = keywordHandler:addKeyword({ "fire bomb rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {fire bomb rune} magic spell for 1500 gold?" })
node15:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "fire bomb rune", vocation = { 1, 2, 5, 6 }, price = 1500, level = 27 })

local node16 = keywordHandler:addKeyword({ "fire field rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {fire field rune} magic spell for 500 gold?" })
node16:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "fire field rune", vocation = { 1, 2, 5, 6 }, price = 500, level = 15 })

local node17 = keywordHandler:addKeyword({ "fire wall rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {fire wall rune} magic spell for 2000 gold?" })
node17:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "fire wall rune", vocation = { 1, 2, 5, 6 }, price = 2000, level = 33 })
...
local node24 = keywordHandler:addKeyword({ "invisibility" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {invisibility} magic spell for 2000 gold?" })
node24:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "invisibility", vocation = { 1, 2, 5, 6 }, price = 2000, level = 35 })
...
local node26 = keywordHandler:addKeyword({ "light magic missile rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {light magic missile rune} magic spell for 500 gold?" })
node26:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "light magic missile rune", vocation = { 1, 2, 5, 6 }, price = 500, level = 15 })
...
local node31 = keywordHandler:addKeyword({ "poison field rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {poison field rune} magic spell for 300 gold?" })
node31:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "poison field rune", vocation = { 1, 2, 5, 6 }, price = 300, level = 14 })

local node32 = keywordHandler:addKeyword({ "poison wall rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {poison wall rune} magic spell for 1600 gold?" })
node32:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "poison wall rune", vocation = { 1, 2, 5, 6 }, price = 1600, level = 29 })

local node33 = keywordHandler:addKeyword({ "stalagmite rune" }, StdModule.say, { npcHandler = npcHandler, onlyFocus = true, text = "Would you like to learn {stalagmite rune} magic spell for 1400 gold?" })
node33:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "stalagmite rune", vocation = { 2, 6 }, price = 1400, level = 24 })
