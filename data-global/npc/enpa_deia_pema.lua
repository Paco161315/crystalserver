...
local function hasDawnportShrines(player)
    return player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.FirstShrine) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.SecondShrine) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.ThirdShrine) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.FourthShrine) == 1
end

local function hasAllShrines(player)
    return player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Guidance) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Tranquility) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Respect) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Legacy) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Empathy) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Harmony) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Power) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Knowledge) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Serenity) == 1 and
           player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Eternity) == 1
end
