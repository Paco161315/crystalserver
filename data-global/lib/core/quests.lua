		...
		[46] = {
			...
			missions = {
				...
				[7] = {
					...
					endValue = 4,
					states = {
						[3] = "Find Boreth, the first of the four vampire brothers, hidden somewhere in the castle. Defeat him and bring Julius proof of his death.",
						[4] = "You have defeated Boreth, the first of the four vampire brothers.",
					},
				},
				[8] = {
					...
					states = {
						...
						[4] = "You have defeated Lersatio, the second vampire brother.",
					},
				},
				[9] = {
