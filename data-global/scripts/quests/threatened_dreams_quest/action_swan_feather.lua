...
function swanfeather.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	local cooldownExpires = player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission05.SwanFeatherCooldown)
	...
	player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission05.SwanFeatherCooldown, timeNow + cooldownTime)
