...
function skinning.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if target.itemid == 8109 and item.itemid == 5942 then
		local missionItems = {
    [Storage.Quest.U8_4.BloodBrothers.Mission06] = {id = 8717, name = "Boreth",  next = Storage.Quest.U8_4.BloodBrothers.Mission07},
    [Storage.Quest.U8_4.BloodBrothers.Mission07] = {id = 8718, name = "Lersatio", next = Storage.Quest.U8_4.BloodBrothers.Mission08},
    [Storage.Quest.U8_4.BloodBrothers.Mission08] = {id = 8719, name = "Marziel",  next = Storage.Quest.U8_4.BloodBrothers.Mission09},
    [Storage.Quest.U8_4.BloodBrothers.Mission09] = {id = 8720, name = "Arthei",   next = nil}
}
